...
class MPsetting(unittest.TestCase):
	...
	def test_into_setting_page(self):
		...
		sleep(1)
		"""
		text = self.driver.find_element_by_xpath('//android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.RelativeLayout[4]/android.widget.TextView[1]').get_attribute("text")
		print text
